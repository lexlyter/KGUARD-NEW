...
namespace NetFwTypeLib
{
  ...
  public interface INetFwPolicy2
  {
    ...
    [DispId(4)]
    bool BlockAllInboundTraffic { [DispId(4), MethodImpl(MethodImplOptions.InternalCall)] get; [DispId(4), MethodImpl(MethodImplOptions.InternalCall)] set; }
    ...
    [DispId(6)]
    bool UnicastResponsesToMulticastBroadcastDisabled { [DispId(6), MethodImpl(MethodImplOptions.InternalCall)] get; [DispId(6), MethodImpl(MethodImplOptions.InternalCall)] set; }

    [DispId(7)]
    INetFwRules Rules { [DispId(7), MethodImpl(MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Interface)] get; }

    [DispId(8)]
    INetFwServiceRestriction ServiceRestriction { [DispId(8), MethodImpl(MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Interface)] get; }

    [DispId(12)]
    NET_FW_ACTION_ DefaultInboundAction { [DispId(12), MethodImpl(MethodImplOptions.InternalCall)] get; [DispId(12), MethodImpl(MethodImplOptions.InternalCall)] set; }

    [DispId(13)]
    NET_FW_ACTION_ DefaultOutboundAction { [DispId(13), MethodImpl(MethodImplOptions.InternalCall)] get; [DispId(13), MethodImpl(MethodImplOptions.InternalCall)] set; }

    [DispId(14)]
    bool IsRuleGroupCurrentlyEnabled { [DispId(14), MethodImpl(MethodImplOptions.InternalCall)] get; }

    [DispId(15)]
    NET_FW_MODIFY_STATE_ LocalPolicyModifyState { [DispId(15), MethodImpl(MethodImplOptions.InternalCall)] get; }
